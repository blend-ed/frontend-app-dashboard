    ...
    <div className={`event-card event-${variant}`} {...props}>
      <div className="event-card-header">
        <div className="event-card-date">
          <Icon icon='calendar' type='line' className="event-card-icon" size='md' />
          {new Date(date).toLocaleDateString()}
        </div>
        <div className="event-card-time">
          <Icon icon='time' type='line' className="event-card-icon" size='md' />
      ...
      <div className="event-card-body">
        ...
        {link && <Link className="event-card-link" to={link}>
          <Icon icon='link' className="event-card-icon" size='md' />
          join meeting
        </Link>}
      </div>
    </div>
